        ...
        <PAGE>
           <div className="container px-0">
               ...
               <div className="col-xl-10 mx-auto px-xl-0 pb-4 mb-4">
                   ...
                   >
                       <Sitio disabled={!completados.registro}/>
                   </MyTab>

                   <MyTab  title={"Adicionales"} open={tab === 3} icon={2} handle={()=> setTab(3)}>
                       <Adicionales
                           disabled={!completados.sitio}
                       />
                   </MyTab>

                   <MyTab title={"Logo"} open={tab === 4} icon={3} handle={()=> setTab(4)}>
                       <Logo
                           disabled={!completados.adicionales}
                       />
                   </MyTab>

                   <MyTab disabled={!completados.logo} title={"Dominio"} open={tab === 5} icon={4} handle={()=> setTab(5)}>
                       <h1>Dominio</h1>
                   </MyTab>

                   <MyTab  title={"Hosting"} open={tab === 6} icon={5} handle={()=> setTab(6)}>
                      <Hosting
                          disabled={!completados.dominio}
                      />
                   </MyTab>

                   <MyTab  title={"Certificado de seguridad y CDN"} open={tab === 7} icon={6} handle={()=> setTab(7)}>
                       <Certificado
                           disabled={!completados.hosting}
                       />
                   </MyTab>

                   <MyTab  title={"Marketing digital"} open={tab === 8} icon={7} handle={()=> setTab(8)}>
                      <Marketing
                   ...
                   <div className="wc">
                       <Resumen className={"p-3 px-lg-4"}>
                           <div className="titulo text-center col-12 col-md-10 col-lg-8 mx-auto">
                               <b>¡Felicidades! A continuación te mostramos un resumen de tu cotización. El botón de la parte inferior la enviará en PDF a tu correo.</b>
                           </div>
                           ...
                           <Flex alg={"stretch"}>
                               <div className={"card col-12 col-md-4 p-3"}>
                                   <div className="text-center">
                                       ...
                                       <br/>
                                       <small className={"d-block"}>Cancela tu cotización y obtén un precio especial. </small>
                                   </div>
                                   ...
                                   <div className="wc text-right">
                                       <div className="wc text-right">
                                           <span className={"d-block"} style={{fontSize:"13px",textDecoration:"line-through "}}>$2.000.000</span>
                                       </div>
                               ...
                               <div className={"col-md-8 pl-md-3 px-0 mt-4 mt-md-0 "}>
                                   <Flex className="card hc p-3 wc" column>
                                       <Flex className={"wc"} flex={"1 0 100px"}>
                                           ...
                                           <div className="ContTabla wc" style={{overflow:"hidden",overflowX:"auto"}}>
                                               <TableR className={""}>
                                                   <thead>
                                                   <tr>
                                                       <th><small><b>Producto</b></small></th>
                                                       <th><small><b>Unidad</b></small></th>
                                                       <th><small><b>Valor unidad</b></small></th>
                           ...
                           <div className="wc cg py-4" style={{color:Colors.grey02,maxWidth:"700px"}} >
                               <small className={"d-block"}>Estos precios no incluyen IVA. Por favor presione el botón "Finalizar y enviar cotización" para recibirla en su correo de forma inmediata, por favor revise la bandeja de entrada.</small>
                           </div>
